#ifndef PROGRESSIVE_PARTICLE_SAMPLER_H_
#define PROGRESSIVE_PARTICLE_SAMPLER_H_
...
class NdfProgressiveParticleSampler : public NdfSampler<BinType> {
public:
	NdfProgressiveParticleSampler(NdfTree<BinType> &ndfTree) : NdfSampler(ndfTree) {}
...
#endif // PROGRESSIVE_PARTICLE_SAMPLER_H_