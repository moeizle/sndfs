...
public:
	QuantizedGaussian(uint32_t quantizedData) : data(quantizedData) {};
...
public:
	ApproximationResult Approximate(glm::ivec2 histogramResolution, glm::ivec2 spatialResolution, int maxClusters, std::vector<float> data, int emIterations);
